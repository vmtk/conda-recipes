...
cmake .. -G "Ninja" ^
    ...
    -DVMTK_SCRIPTS_INSTALL_LIB_DIR="%LIBRARY_LIB%/python%PY_VER:~0,1%.%PY_VER:~2,1%/site-packages/vmtk" ^
    -DPYPES_INSTALL_BIN_DIR="%LIBRARY_BIN%" ^
    -DPYPES_MODULE_INSTALL_LIB_DIR="%LIBRARY_LIB%/python%PY_VER:~0,1%.%PY_VER:~2,1%/site-packages/vmtk" ^
