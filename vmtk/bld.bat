...
cmake .. -LAH -G "Ninja" ^
    ...
    -DVMTK_MODULE_INSTALL_LIB_DIR:FILEPATH="%LIBRARY_LIB%/vmtk" ^
    -DVTK_VMTK_WRAPPED_MODULE_INSTALL_LIB_DIR:FILEPATH="%LIBRARY_LIB%/vmtk" ^
	-DVTK_VMTK_INSTALL_LIB_DIR:FILEPATH="%LIBRARY_LIB%/vmtk" ^
	-DVTK_VMTK_INSTALL_BIN_DIR:FILEPATH="%LIBRARY_BIN%" ^
	-DVMTK_SCRIPTS_INSTALL_LIB_DIR:FILEPATH="%LIBRARY_LIB%/vmtk" ^
	-DVMTK_SCRIPTS_INSTALL_BIN_DIR:FILEPATH="%LIBRARY_BIN%" ^
	-DVMTK_CONTRIB_SCRIPTS_INSTALL_LIB_DIR:FILEPATH="%LIBRARY_LIB%/vmtk" ^
	-DVMTK_CONTRIB_SCRIPTS_INSTALL_BIN_DIR:FILEPATH="%LIBRARY_BIN%" ^
	-DPYPES_MODULE_INSTALL_LIB_DIR:FILEPATH="%LIBRARY_LIB%/vmtk" ^
